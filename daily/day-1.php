...
<div class="center">
	...
	<!--lightup-->
			...
			<div class="x-mas-center-text" ><span style="font-size:20px;"><?php echo __("Day 1 Thanks for participating"); ?></span><div class="h10"></div>
				<span style="font-size:26px;"><?php echo __("Today´s gift:"); ?> </span><br/>	<span style="font-size:32px;"><?php echo __("25% discount for everyone!"); ?></span>  <div style="text-align:center; margin-top:10px;"><img src="/daily/images/Red_hat_03.png"></div>
				<span style="font-size:18px;"><?php echo __("Shortly, you will recieve an email with your voucher code! Valid for 24 hours! <br>Come back tomorrow to see the next gift!"); ?></span>
			</div>
			
		<!--box-->
		
			<div class="x-mas-middle-box"><img src="/daily/images/day-1.png">
			<?php if($key[$today] > $_GET['page']) {
				echo '<div class="archieved-img"><img src="/daily/images/Archieved_03.png"></div>';
			} ?>
			<div class="comment_day1"><div><?php echo __("Sign up and get"); ?></div></div>
			<div class="voucher_day1"><div><?php echo __("25% off<br> voucher"); ?></div></div>
