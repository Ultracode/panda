...
<div class="x-mas-food-container">
	...
	<!--lightup-->
			...
			<div class="x-mas-center-text" ><span style="font-size:20px;"><?php echo __("Day 2 Thanks for participating"); ?></span><div class="h10"></div>
				<span style="font-size:26px;"><?php echo __("Today´s gift:"); ?> </span><br/>	<span style="font-size:32px;"><?php echo __("Pizza party for you and your friends"); ?></span>  <div style="text-align:center; margin-top:10px;"><img src="/daily/images/Red_hat_03.png"></div>
				<span style="font-size:16px;"><?php echo __("Come back tomorrow to see the next gift"); ?></span>
			</div>
			
		<!--box-->
		
			<div class="x-mas-middle-box"><img src="/daily/images/day-2.png">
						<div class="comment_day2"><div><?php echo __("Pizza party"); ?></div></div>
									<div class="voucher_day2"><div><?php echo __("Mention 3 friends you would like to have a pizza party with in the comment"); ?></div></div>
