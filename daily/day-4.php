...
<div class="center">
	...
	<!--lightup-->
			...
			<div class="x-mas-center-text" ><span style="font-size:20px;"><?php echo __("Day 4 Thanks for participating"); ?></span><div class="h10"></div>
				<span style="font-size:26px;"><?php echo __("Today´s gift:"); ?> </span><br/>	<span style="font-size:32px;"><?php echo __("Food for the needy"); ?></span>  <div style="text-align:center; margin-top:10px;"><img src="/daily/images/Red_hat_03.png"></div>
				<span style="font-size:16px;"><?php echo __("Come back tomorrow to see the next gift"); ?></span>
			</div>
			
		<!--box-->
		
			<div class="x-mas-middle-box"><img src="/daily/images/day-4.png">
						<div class="comment_day4"><div><?php echo __("You say we give: Mention the food item you would like to give and we will donate it"); ?> <br /><br />

	<?php echo __("Your efforts support your local homeless shelters"); ?></div></div>
