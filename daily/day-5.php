...
<div class="x-mas-food-container">
	...
	<!--lightup-->
			...
			<div class="x-mas-center-text" ><span style="font-size:20px;"><?php echo __("Day 5 Thanks for participating"); ?></span><div class="h10"></div>
				<span style="font-size:26px;"><?php echo __("Today´s gift:"); ?> </span><br/>	<span style="font-size:32px;"><?php echo __("Tickets to the cinema for X2"); ?></span>  <div style="text-align:center; margin-top:10px;"><img src="/daily/images/Red_hat_03.png"></div>
				<span style="font-size:16px;"><?php echo __("Come back tomorrow to see the next gift"); ?></span>
			</div>
			
		<!--box-->
		
			<div class="x-mas-middle-box"><img src="/daily/images/day-5.png">
			<div class="comment_day4"><div> <?php echo __("Comment what is your favorite Christmas movie"); ?> </div></div>
